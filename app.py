...
DRIVE = {
    ...
    'city_season' : '1dDUTxVbWJdDpEhkBu7Klv5ehU0pAyoVB',  # v6: B weights + 60-festival systematic table + physics gates
    'state_season': '1V3Rmu4h7pyOB5K3zlycKbR00-SRhdeKu',    # v6: state scores via direct place-pooling + 60-festival table
...
# Regional festival table — 60 major festivals, verified 2026 dates, Jul->Jan
# forecast window. Monthly signal feeds city/state scores; 'windows' drive
# the place-level festival-DAY boost. Refresh dates yearly (lunar calendar).
REGIONAL_FESTIVALS = [{'festival': 'Rath Yatra',
  'month': 7,
  'scope': 'city',
  'value': 'Puri',
  'magnitude': 3,
  'windows': [{'start': '2026-07-16', 'end': '2026-07-26', 'label': 'Rath Yatra', 'verified': True}]},
 {'festival': 'Rath Yatra',
  'month': 7,
  'scope': 'city',
  'value': 'Ahmedabad',
  'magnitude': 2,
  'windows': [{'start': '2026-07-16', 'end': '2026-07-16', 'label': 'Rath Yatra', 'verified': True}]},
 {'festival': 'Rath Yatra',
  'month': 7,
  'scope': 'city',
  'value': 'Ranchi',
  'magnitude': 2,
  'windows': [{'start': '2026-07-16', 'end': '2026-07-24', 'label': 'Rath Yatra', 'verified': False}]},
 {'festival': 'Bonalu',
  'month': 7,
  'scope': 'city',
  'value': 'Hyderabad',
  'magnitude': 2,
  'windows': [{'start': '2026-07-05', 'end': '2026-07-27', 'label': 'Bonalu', 'verified': False}]},
 {'festival': 'Hemis Festival',
  'month': 7,
  'scope': 'city',
  'value': 'Leh',
  'magnitude': 2,
  'windows': [{'start': '2026-07-24', 'end': '2026-07-25', 'label': 'Hemis Festival', 'verified': False}]},
 {'festival': 'Guru Purnima',
  'month': 7,
  'scope': 'state',
  'value': 'Uttar Pradesh',
  'magnitude': 1,
  'windows': [{'start': '2026-07-29', 'end': '2026-07-29', 'label': 'Guru Purnima', 'verified': True}]},
 {'festival': 'Kanwar Yatra',
  'month': 7,
  'scope': 'city',
  'value': 'Haridwar',
  'magnitude': 3,
  'windows': [{'start': '2026-07-10', 'end': '2026-07-30', 'label': 'Kanwar Yatra', 'verified': False}]},
 {'festival': 'Amarnath Yatra',
  'month': 7,
  'scope': 'city',
  'value': 'Pahalgam',
  'magnitude': 3,
  'windows': [{'start': '2026-07-01', 'end': '2026-08-19', 'label': 'Amarnath Yatra', 'verified': False}]},
 {'festival': 'Onam',
  'month': 8,
  'scope': 'state',
  'value': 'Kerala',
  'magnitude': 3,
  'windows': [{'start': '2026-08-16', 'end': '2026-08-26', 'label': 'Onam', 'verified': True}]},
 {'festival': 'Nehru Trophy Boat Race',
  'month': 8,
  'scope': 'city',
  'value': 'Alappuzha',
  'magnitude': 2,
  'windows': [{'start': '2026-08-08', 'end': '2026-08-08', 'label': 'Nehru Trophy Boat Race', 'verified': False}]},
 {'festival': 'Independence Day',
  'month': 8,
  'scope': 'city',
  'value': 'Delhi',
  'magnitude': 1,
  'windows': [{'start': '2026-08-15', 'end': '2026-08-15', 'label': 'Independence Day', 'verified': True}]},
 {'festival': 'Janmashtami',
  'month': 8,
  'scope': 'city',
  'value': 'Mathura',
  'magnitude': 3,
  'windows': [{'start': '2026-09-04', 'end': '2026-09-04', 'label': 'Janmashtami', 'verified': True}]},
 {'festival': 'Raksha Bandhan',
  'month': 8,
  'scope': 'state',
  'value': 'Uttar Pradesh',
  'magnitude': 1,
  'windows': [{'start': '2026-08-28', 'end': '2026-08-28', 'label': 'Raksha Bandhan', 'verified': True}]},
 {'festival': 'Teej',
  'month': 8,
  'scope': 'city',
  'value': 'Jaipur',
  'magnitude': 2,
  'windows': [{'start': '2026-08-15', 'end': '2026-08-16', 'label': 'Teej', 'verified': False}]},
 {'festival': 'Nag Panchami',
  'month': 8,
  'scope': 'state',
  'value': 'Maharashtra',
  'magnitude': 1,
  'windows': [{'start': '2026-08-18', 'end': '2026-08-18', 'label': 'Nag Panchami', 'verified': False}]},
 {'festival': 'Ganesh Chaturthi',
  'month': 9,
  'scope': 'city',
  'value': 'Mumbai',
  'magnitude': 3,
  'windows': [{'start': '2026-09-14', 'end': '2026-09-24', 'label': 'Ganesh Chaturthi', 'verified': True}]},
 {'festival': 'Ganesh Chaturthi',
  'month': 9,
  'scope': 'city',
  'value': 'Pune',
 ...
 {'festival': 'Ganesh Chaturthi',
  ...
  'magnitude': 2,
  'windows': [{'start': '2026-09-14', 'end': '2026-09-24', 'label': 'Ganesh Chaturthi', 'verified': True}]},
 {'festival': 'Onam finale',
  'month': 9,
  'scope': 'state',
  'value': 'Kerala',
  'magnitude': 1,
  'windows': [{'start': '2026-09-01', 'end': '2026-09-02', 'label': 'Onam finale', 'verified': False}]},
 {'festival': 'Sharad Navratri',
  'month': 10,
  'scope': 'state',
  'value': 'Gujarat',
  'magnitude': 3,
  'windows': [{'start': '2026-10-11', 'end': '2026-10-20', 'label': 'Sharad Navratri', 'verified': True}]},
 {'festival': 'Navratri Garba',
  'month': 10,
  'scope': 'city',
  'value': 'Ahmedabad',
  'magnitude': 3,
  'windows': [{'start': '2026-10-11', 'end': '2026-10-20', 'label': 'Navratri Garba', 'verified': True}]},
 {'festival': 'Navratri Garba',
  'month': 10,
  'scope': 'city',
  'value': 'Vadodara',
 ...
 {'festival': 'Durga Puja',
  ...
  'value': 'Kolkata',
  'magnitude': 3,
  'windows': [{'start': '2026-10-17', 'end': '2026-10-21', 'label': 'Durga Puja', 'verified': True}]},
 {'festival': 'Durga Puja',
  'month': 10,
  'scope': 'state',
  'value': 'West Bengal',
 ...
 {'festival': 'Mysore Dasara',
  ...
  'value': 'Mysuru',
  'magnitude': 3,
  'windows': [{'start': '2026-10-11', 'end': '2026-10-20', 'label': 'Mysore Dasara', 'verified': True}]},
 {'festival': 'Dussehra',
  'month': 10,
  'scope': 'city',
  'value': 'Kullu',
  'magnitude': 3,
  'windows': [{'start': '2026-10-20', 'end': '2026-10-26', 'label': 'Dussehra', 'verified': True}]},
 {'festival': 'Ramlila Dussehra',
  'month': 10,
  'scope': 'city',
  'value': 'Delhi',
  'magnitude': 2,
  'windows': [{'start': '2026-10-11', 'end': '2026-10-20', 'label': 'Ramlila Dussehra', 'verified': True}]},
 {'festival': 'Dussehra',
  'month': 10,
  'scope': 'state',
  'value': 'Uttar Pradesh',
  'magnitude': 1,
  'windows': [{'start': '2026-10-20', 'end': '2026-10-20', 'label': 'Dussehra', 'verified': True}]},
 {'festival': 'Diwali',
  'month': 11,
  'scope': 'city',
  'value': 'Ayodhya',
  'magnitude': 3,
  'windows': [{'start': '2026-11-06', 'end': '2026-11-10', 'label': 'Diwali', 'verified': True}]},
 {'festival': 'Diwali',
  'month': 11,
  'scope': 'city',
  'value': 'Varanasi',
 ...
 {'festival': 'Diwali',
  ...
  'value': 'Amritsar',
  'magnitude': 2,
  'windows': [{'start': '2026-11-08', 'end': '2026-11-08', 'label': 'Diwali', 'verified': True}]},
 {'festival': 'Diwali',
  'month': 11,
  'scope': 'state',
  'value': 'Uttar Pradesh',
 ...
 {'festival': 'Chhath Puja',
  ...
  'value': 'Bihar',
  'magnitude': 3,
  'windows': [{'start': '2026-11-15', 'end': '2026-11-16', 'label': 'Chhath Puja', 'verified': True}]},
 {'festival': 'Chhath Puja',
  'month': 11,
  'scope': 'city',
  'value': 'Patna',
 ...
 {'festival': 'Dev Deepawali',
  ...
  'value': 'Varanasi',
  'magnitude': 3,
  'windows': [{'start': '2026-11-23', 'end': '2026-11-24', 'label': 'Dev Deepawali', 'verified': True}]},
 {'festival': 'Pushkar Camel Fair',
  'month': 11,
  'scope': 'city',
  'value': 'Pushkar',
  'magnitude': 3,
  'windows': [{'start': '2026-11-17', 'end': '2026-11-24', 'label': 'Pushkar Camel Fair', 'verified': False}]},
 {'festival': 'Guru Nanak Jayanti',
  'month': 11,
  'scope': 'city',
  'value': 'Amritsar',
  'magnitude': 3,
  'windows': [{'start': '2026-11-24', 'end': '2026-11-24', 'label': 'Guru Nanak Jayanti', 'verified': True}]},
 {'festival': 'Sonepur Mela',
  'month': 11,
  'scope': 'city',
  'value': 'Sonepur',
  'magnitude': 2,
  'windows': [{'start': '2026-11-24', 'end': '2026-12-15', 'label': 'Sonepur Mela', 'verified': False}]},
 {'festival': 'Wangala Festival',
  'month': 11,
  'scope': 'state',
  'value': 'Meghalaya',
  'magnitude': 1,
  'windows': [{'start': '2026-11-07', 'end': '2026-11-08', 'label': 'Wangala Festival', 'verified': False}]},
 ...
 {'festival': 'Rann Utsav',
  ...
  'value': 'Kutch',
  'magnitude': 3,
  'windows': [{'start': '2026-11-01', 'end': '2027-02-28', 'label': 'Rann Utsav', 'verified': True}]},
 {'festival': 'Konark Dance Festival',
  'month': 12,
  'scope': 'city',
  'value': 'Konark',
  'magnitude': 2,
  'windows': [{'start': '2026-12-01', 'end': '2026-12-05', 'label': 'Konark Dance Festival', 'verified': False}]},
 {'festival': 'Christmas',
  'month': 12,
  'scope': 'state',
  'value': 'Goa',
  'magnitude': 3,
  'windows': [{'start': '2026-12-24', 'end': '2026-12-26', 'label': 'Christmas', 'verified': True}]},
 {'festival': 'Christmas',
  'month': 12,
  'scope': 'city',
  'value': 'Kolkata',
 ...
 {'festival': 'New Year Eve',
  ...
  'value': 'Goa',
  'magnitude': 3,
  'windows': [{'start': '2026-12-28', 'end': '2026-12-31', 'label': 'New Year Eve', 'verified': True}]},
 {'festival': 'Galdan Namchot',
  'month': 12,
  'scope': 'city',
  'value': 'Leh',
  'magnitude': 1,
  'windows': [{'start': '2026-12-14', 'end': '2026-12-15', 'label': 'Galdan Namchot', 'verified': False}]},
 {'festival': 'Makar Sankranti',
  'month': 1,
  'scope': 'state',
  'value': 'Gujarat',
  'magnitude': 2,
  'windows': [{'start': '2027-01-14', 'end': '2027-01-15', 'label': 'Makar Sankranti', 'verified': True}]},
 {'festival': 'Uttarayan Kite Festival',
  'month': 1,
  'scope': 'city',
  'value': 'Ahmedabad',
  'magnitude': 3,
  'windows': [{'start': '2027-01-13', 'end': '2027-01-15', 'label': 'Uttarayan Kite Festival', 'verified': True}]},
 {'festival': 'Pongal',
  'month': 1,
  'scope': 'state',
  'value': 'Tamil Nadu',
  'magnitude': 3,
  'windows': [{'start': '2027-01-14', 'end': '2027-01-17', 'label': 'Pongal', 'verified': True}]},
 {'festival': 'Lohri',
  'month': 1,
  'scope': 'state',
  'value': 'Punjab',
  'magnitude': 2,
  'windows': [{'start': '2027-01-13', 'end': '2027-01-13', 'label': 'Lohri', 'verified': True}]},
 {'festival': 'Gangasagar Mela',
  'month': 1,
  'scope': 'city',
  'value': 'Kolkata',
  'magnitude': 2,
  'windows': [{'start': '2027-01-13', 'end': '2027-01-15', 'label': 'Gangasagar Mela', 'verified': False}]},
 {'festival': 'Rann Utsav',
  'month': 1,
  'scope': 'city',
  'value': 'Kutch',
  'magnitude': 3,
  'windows': [{'start': '2027-01-01', 'end': '2027-01-31', 'label': 'Rann Utsav', 'verified': True}]},
 ...
 {'festival': 'Kumbh/Magh Mela',
  'month': 1,
  'scope': 'city',
  'value': 'Prayagraj',
  'magnitude': 2,
  'windows': [{'start': '2027-01-14', 'end': '2027-02-15', 'label': 'Kumbh/Magh Mela', 'verified': False}]}]
print(f'Regional festivals: {len(REGIONAL_FESTIVALS)} entries (embedded, synced with city/state)')
